...
<script src="files/domready.min.js" type="text/javascript"></script>
<script type="text/javascript">
	DomReady.ready(function() {
		var $A = document.getElementsByTagName('a');
		for($a in $A){
			if($A[$a].title == 'The default category '){
		...
		ss_playpause();
		document
			.getElementById('ss_playpause_link2')
			.parentNode
			.style
			.display = "none";
		document
			.getElementById('ss_playpause_link')
			.parentNode
			.style
			.display = "none";		
	});
